...
def send_email(subject, message):
    ...
    receiver_email = "pectuscycus@gmail.com"  # Replace with recipient email address
...
def monitor():
    ...
    if ram_percent >= 80:
        ...
        send_email("High RAM Usage", "RAM usage is above 80% for too long.")
    ...
    if storage_percent >= 80:
        ...
        send_email("High Storage Usage", "Storage usage is above 80%.")
